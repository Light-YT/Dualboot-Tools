# LightSn0w
LightSn0w is my first jailbreak tool based on the checkm8 exploit.  
    
__UPDATE:__ LightSn0w will now install Sileo, SSH and Substitute automatically! Additionally, all changes to the root file system are now persistent. Put your iDevice into DFU mode, run `LightSn0w iStrap`, unlock your iDevice and follow the on-screen prompts.  
__IMPORTANT:__ This jailbreak is currently in development and only meant to be used by developers.  

# Supported Devices
Currently, the iPad Pro (2017, every size) and iPhone 7 are the only officially supported devices (on iOS 13 - 13.6.1).  
...
**LightSn0w will now install Sileo, SSH and Substitute automatically!** Unlock your iDevice and follow the on-screen prompts. Make sure your iDevice is connected to the internet!

# Components
LightSn0w consists of the following components:
...
* miniz developers for the miniz library. [Light-YT](https://twitter.com/Light_iDev) the creator of the LightSn0w UI
